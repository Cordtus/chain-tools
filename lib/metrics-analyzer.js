/**
 * Post-run metrics engine: records tx outcomes, categorizes failures, snapshots
 * the mempool, and analyzes blocks for inclusion rate and gas efficiency.
 * Emits a console report + detailed-metrics-{timestamp}.json.
 *
 * Used by blockchain-spammer.js. The standalone run below is a demo with
 * sample data.
 */
