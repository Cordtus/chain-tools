    ...
    heavy: [
      {
        ...
        description: "Extremely high volume DEX router - thousands of swaps daily",
        topics: [
      ...
      },
      {
        ...
        description: "Highest volume stablecoin - millions of transfers",
        topics: [
      ...
      },
      {
        ...
        description: "Second highest volume stablecoin",
        topics: [
          "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef", // Transfer event
        ]
      },
      {
        ...
        description: "NFT marketplace - high event variety",
        topics: [] // All events for maximum scatter
      },
      {
        name: "Wrapped Ether",
        address: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2",
        description: "Most wrapped asset - deposit/withdrawal events",
        topics: [
    ...
    heavy: [
      {
        ...
        description: "Bridged USDC - highest volume on Polygon",
        topics: ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"]
      },
      {
        name: "QuickSwap Router",
        address: "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff",
        description: "Main Polygon DEX",
        topics: []
      },
      {
        name: "Aave V3 Pool",
        address: "0x794a61358D6845594F94dc1DB02A252b5b4814aD",
        description: "Lending protocol - many event types",
        topics: []
      }
    ],
    medium: [
    ...
    heavy: [
      {
        ...
        description: "High volume perp DEX",
        topics: []
      },
      {
        name: "Uniswap V3 Router",
        address: "0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45",
        description: "Uniswap on Arbitrum",
        topics: []
      },
      {
        name: "USDC Native",
    ...
    medium: [
      {
        ...
        description: "SushiSwap on Arbitrum",
        topics: []
      }
    ],
    light: [
    ...
    heavy: [
      {
        ...
        description: "USD Base Coin - highest volume",
        topics: ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"]
      },
      {
        name: "Aerodrome Router",
        address: "0xcF77a3Ba9A5CA399B7c97c74d54e5b1Beb874E43",
        description: "Main Base DEX",
        topics: []
      }
    ],
    medium: [
    ...
    heavy: [
      {
        ...
        description: "Highest volume DEX on BSC",
        topics: []
      },
      {
        name: "BUSD Token",
    ...
    heavy: [
      {
        ...
        description: "Main Avalanche DEX",
        topics: []
      },
      {
        name: "USDC.e",
...
export const LOAD_STRATEGIES = {
  ...
  scatter: {
    ...
    description: "Query all events without filtering - maximum data scatter",
    topics: [],
    includeAllLogs: true
  },
  ...
  highFrequency: {
    ...
    description: "Focus on Transfer events which occur most frequently",
    topics: ["0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef"]
  },
  
  // No address filter - query ALL contracts (extremely heavy)
  chaos: {
    name: "Chaos Mode",
    ...
    warning: " This mode queries ALL contracts and can overwhelm nodes!"
  }
};
